...
##        form_table_format.setColumnWidthConstraints(table_constraints)
        ...
        cellCursor = cell.firstCursorPosition()
        cellCursor.insertText(Traveller.starport_types[starport_max], body_text_format)
        cell = main_table.cellAt(1, 2)
        cellCursor = cell.firstCursorPosition()
        cellCursor.insertText(Traveller.starport_types[starport_avg], body_text_format)
        cell = main_table.cellAt(1, 3)
        cellCursor = cell.firstCursorPosition()
        cellCursor.insertText(Traveller.starport_types[starport_min], body_text_format)
        ...
        cellCursor = cell.firstCursorPosition()
        cellCursor.insertText(Traveller.size_types[size_min], body_text_format)
        cell = main_table.cellAt(2, 2)
        cellCursor = cell.firstCursorPosition()
        cellCursor.insertText(Traveller.size_types[size_avg], body_text_format)
        cell = main_table.cellAt(2, 3)
        cellCursor = cell.firstCursorPosition()
        cellCursor.insertText(Traveller.size_types[size_max], body_text_format)
        ...
        cellCursor = cell.firstCursorPosition()
        cellCursor.insertText(Traveller.atmosphere_types[atmo_min], body_text_format)
        cell = main_table.cellAt(3, 2)
        cellCursor = cell.firstCursorPosition()
        cellCursor.insertText(Traveller.atmosphere_types[atmo_avg], body_text_format)
        cell = main_table.cellAt(3, 3)
        cellCursor = cell.firstCursorPosition()
        cellCursor.insertText(Traveller.atmosphere_types[atmo_max], body_text_format)
        ...
        cellCursor = cell.firstCursorPosition()
        cellCursor.insertText(Traveller.hydrographics_types[hydro_min], body_text_format)
        cell = main_table.cellAt(4, 2)
        cellCursor = cell.firstCursorPosition()
        cellCursor.insertText(Traveller.hydrographics_types[hydro_avg], body_text_format)
        cell = main_table.cellAt(4, 3)
        cellCursor = cell.firstCursorPosition()
        cellCursor.insertText(Traveller.hydrographics_types[hydro_max], body_text_format)
        ...
        cellCursor = cell.firstCursorPosition()
        cellCursor.insertText(Traveller.population_types[pop_min], body_text_format)
        cell = main_table.cellAt(5, 2)
        cellCursor = cell.firstCursorPosition()
        cellCursor.insertText(Traveller.population_types[pop_avg], body_text_format)
        cell = main_table.cellAt(5, 3)
        cellCursor = cell.firstCursorPosition()
        cellCursor.insertText(Traveller.population_types[pop_max], body_text_format)
        ...
        cellCursor = cell.firstCursorPosition()
        cellCursor.insertText(Traveller.government_types[gov_min], body_text_format)
        cell = main_table.cellAt(6, 2)
        cellCursor = cell.firstCursorPosition()
        cellCursor.insertText(Traveller.government_types[gov_avg], body_text_format)
        cell = main_table.cellAt(6, 3)
        cellCursor = cell.firstCursorPosition()
        cellCursor.insertText(Traveller.government_types[gov_max], body_text_format)
        ...
        cellCursor = cell.firstCursorPosition()
        cellCursor.insertText(Traveller.law_level_types[law_min], body_text_format)
        cell = main_table.cellAt(7, 2)
        cellCursor = cell.firstCursorPosition()
        cellCursor.insertText(Traveller.law_level_types[law_avg], body_text_format)
        cell = main_table.cellAt(7, 3)
        cellCursor = cell.firstCursorPosition()
        cellCursor.insertText(Traveller.law_level_types[law_max], body_text_format)
        ...
        cellCursor = cell.firstCursorPosition()
        cellCursor.insertText(Traveller.tech_level_types[tech_min], body_text_format)
        cell = main_table.cellAt(8, 2)
        cellCursor = cell.firstCursorPosition()
        cellCursor.insertText(Traveller.tech_level_types[tech_avg], body_text_format)
        cell = main_table.cellAt(8, 3)
        cellCursor = cell.firstCursorPosition()
        cellCursor.insertText(Traveller.tech_level_types[tech_max], body_text_format)
