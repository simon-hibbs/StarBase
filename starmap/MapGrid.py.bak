...
class Grid(QtGui.QGraphicsItem):
    def __init__(self, secs_wide=1, secs_high=1, parent=None):
        ...
        #self.planet_root = PlanetRoot()
        #self.planet_root.setParentItem(self)
...
##    def refreshAllegianceDisplay(self):
##        if self.displayAllegiances = True:
##            self.toggleAllegianceDisplay(self, False)
##            self.toggleAllegianceDisplay(self, True)
##        else:
##            self.toggleAllegianceDisplay(self, False)
